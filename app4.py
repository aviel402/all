...
PROGRAMS = {
    ...
    "p1": {"name": "BRUTE FORCE", "ram": 2, "dmg": 15, "risk": 4, "type": "atk", "desc": "זול ומהיר."},
    "p2": {"name": "SQL INJECT",  "ram": 4, "dmg": 40, "risk": 8, "type": "atk", "desc": "נזק כבד."},
    "p3": {"name": "ROOTKIT_ZERO","ram": 8, "dmg": 100,"risk": 20,"type": "atk", "desc": "נשק יום הדין."},
    
    # תוכנות הגנה (מורידות סיכון)
    "d1": {"name": "IP SPOOF",    "ram": 2, "heal": 5, "type": "def", "desc": "מוריד 5% מעקב."},
    "d2": {"name": "LOG WIPER",   "ram": 5, "heal": 20, "type": "def", "desc": "מנקה 20% מעקב."}
}

TARGETS = [
    {"name": "ATM שכונתי", "def": 40, "cash": 50},
    {"name": "רשת בית ספר", "def": 100, "cash": 150},
    {"name": "בנק דיגיטלי", "def": 300, "cash": 700},
    {"name": "שרתי הממשלה", "def": 800, "cash": 2500},
    {"name": "בסיס צבאי", "def": 2500, "cash": 10000}
]
...
class GameEngine:
    ...
    def reset(self):
        self.state = {
            ...
            "targets_list": [],
            "game_over": False,
            "log": [{"time": self.getTime(), "txt": "M.A.T.R.I.X OS v4.0 Loaded.", "c": "sys"}]
        }
